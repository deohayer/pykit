...
class Arg:
    ...
    def __call__(self, bundle: 'Bundle') -> object:
        return bundle.args().get(self)
...
class App:
    ...
    def main(self) -> int:
        try:
            return Parser(self).main()
        except ParserError as e:
            raise ArgappError(e.message) from e


class Bundle:
    def __init__(self, apps: 'list[App]', args: 'dict[Arg, object]') -> None:
        self.__args = args
        self.__apps = apps

    def args(self) -> 'dict[Arg, object]':
        return self.__args
...
class ParserArg:
    def __init__(self, arg: Arg, papp: 'ParserApp') -> None:
        self.__arg = arg
        self.__papp = papp
    ...
    def validate_options(self) -> None:
        MESS_TYPE = 'Arg.option must be None or Iterable.'
    ...
    def __kwargs_optional(self, kwargs: 'dict[str, object]') -> None:
    ...
    def __kwargs_positional(self, kwargs: 'dict[str, object]') -> None:
...
class ParserApp:
    def __init__(self, app: App, parent: 'ParserApp') -> None:
        self.__app = app
...
class Parser:
    def __init__(self, app: App) -> None:
        self.__papp = ParserApp(app, None)
    ...
    @staticmethod
    def __construct(papp: 'ParserApp', parser: ap.ArgumentParser) -> None:
    ...
    def __subparsers_help(papp: 'ParserApp') -> str:
        ...
        names = [x.app().name() for x in papp.papps()]
        helps = [x.app().help() for x in papp.papps()]
        return help_twins(help, names, helps)
